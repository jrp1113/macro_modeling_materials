...
# The follow in steps were taken in the production of the the macroeconomic models linking population change (desirability) to larger macroeconomic shifts.
...
3-global_implications_tile_data_models.Rmd (not included in repo due to 3rd party restrictions)
...
5-global_implications_national_data_models.Rmd (not included in repo due to 3rd party restrictions)
...
1-GDP_FireFloodWind_DID_Danielle.Rmd (not included in repo due to 3rd party restrictions)
...
2-DiD MEV national estimation.Rmd (not included in repo due to 3rd party restrictions)
